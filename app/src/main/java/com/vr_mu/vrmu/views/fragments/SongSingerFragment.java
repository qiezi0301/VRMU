 ...
 */
public class SongSingerFragment extends BaseFragment implements PullToRefreshView.OnHeaderRefreshListener {
    ...
    protected void initView() {
        ...
        //设置下拉监听器
        mPullToRefreshView.setOnHeaderRefreshListener(SongSingerFragment.this);
    }
    ...
    private void requestLiveData(String language, String category) {
        ...
        String homeUrl = UserServerHelper.SINGER + jsonObject.toString();
    ...
    private void showLiveInfo(SongSingerGson dataList) {
        ...
        singerAdapter = new SingerAdapter(mActivity, R.layout.item_singer, dataList.data);
    ...
    public void onHeaderRefresh(PullToRefreshView view) {
        mPullToRefreshView.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                requestLiveData(SongSingerFragment.this.language, SongSingerFragment.this.category);
            }
        }, 1000);
    }
}
