...
public class ServerHomeFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        final List<BaseFragment> list_fragment = Arrays.asList(new SongSongFragment(), new SongMvFragment(), new SongSingerFragment(), new SongAlbumFragment(), new SongHotFragment());
